...
class Conditional_GAN(tf.keras.Model):
    ...
    def train_step(self, data):
        ...
        image_one_hot_labels = tf.keras.ops.repeat(
            image_one_hot_labels, repeats=[image_size * image_size]
        )
        image_one_hot_labels = tf.keras.ops.reshape(
        ...
        fake_image_and_labels = tf.keras.ops.concatenate(
            [generated_images, image_one_hot_labels], -1
        )
        real_image_and_labels = tf.keras.ops.concatenate([real_images, image_one_hot_labels], -1)
        combined_images = tf.keras.ops.concatenate(
